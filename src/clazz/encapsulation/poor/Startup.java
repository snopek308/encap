 ...
 * classes -- "Engine" and "Car". Think for a minute. Do most people interact
 * with their engines? No! We interact with our car and our car interacts with
 * the engine. For most people the details of how an engine work are not of
 * interest and beyond the comfort level of the average car owner. Requiring
 * communication with both the car and the engine just complicates things. And
 * when your code is complex, many bad things tend to happen, including poor
