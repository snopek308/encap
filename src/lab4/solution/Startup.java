 ...
 * Encapsulation). Also notice how little information about how the rest of the
 ...
 * feasible. Here, only the Company class is exposed. Not knowing about the
 * other classes means this class is not dependent on those other classes and
 * changes can easily be made in those other classes without affecting this
 * class. That means greater flexibility and less rigidity and fragility.
 *
